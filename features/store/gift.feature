...
Scenario: display error message if last name and email match but mailing address does not
  Given I go to the shipping info page for customer "Tom Foolery"
  When I fill in the ".billing_info" fields with "Bob Lennon, Waverly St., Berkeley, CA 99999, 510-999-9999, john@lennon.com"
  And I proceed to checkout
  Then I should be on the shipping info page
  And I should see the message "store.errors.gift_matching_email_diff_address"
